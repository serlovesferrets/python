...
class Dictionary(Generic[_KEY, _VALUE]):
    ...
    def delete(self, k: _KEY | None = None) -> bool:
        this: Dictionary[_KEY, _VALUE] = self
...
def Dictionary__TryFindIndex_2B595(this: Dictionary[_KEY, Any], k: _KEY) -> tuple[bool, int, int]:
    ...
    def _arrow33(__unit: None = None, this: Any = this, k: Any = k) -> Array[Any]:
        return out_arg

    def _arrow34(v: Array[Any], this: Any = this, k: Any = k) -> None:
        nonlocal out_arg
        out_arg = v
    ...
    if match_value[0]:
        ...
        def _arrow35(pair: Any, this: Any = this, k: Any = k) -> bool:
