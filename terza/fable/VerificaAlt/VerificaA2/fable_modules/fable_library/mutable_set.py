...
def HashSet__TryFindIndex_2B595(this: HashSet[_T], k: _T) -> tuple[bool, int, int]:
    ...
    def _arrow25(__unit: None = None, this: Any = this, k: Any = k) -> Array[_T]:
        return out_arg

    def _arrow26(v: Array[_T], this: Any = this, k: Any = k) -> None:
        nonlocal out_arg
        out_arg = v
    ...
    if match_value[0]:
        ...
        def _arrow27(v_1: _T | None = None, this: Any = this, k: Any = k) -> bool:
...
def HashSet__TryFind_2B595(this: HashSet[_T], k: _T) -> _T | None:
