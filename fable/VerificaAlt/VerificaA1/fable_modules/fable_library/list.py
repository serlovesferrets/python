    ...
    def loop(acc_mut: _STATE, node_mut: FSharpList[_T], gen: Any = gen, state: Any = state) -> FSharpList[_T]:
        while True:
            ...
            if match_value is not None:
                ...
                def _arrow68(__unit: None = None, acc: Any = acc, node: Any = node) -> FSharpList[_T]:
    ...
    if is_array_like(xs):
        ...
        with get_enumerator(xs) as enumerator:
            while enumerator.System_Collections_IEnumerator_MoveNext():
                ...
                def _arrow73(__unit: None = None, xs: Any = xs) -> FSharpList[_T]:
...
def scan(folder: Callable[[_STATE, _T], _STATE], state: _STATE, xs: FSharpList[_T]) -> FSharpList[_STATE]:
    ...
    while not FSharpList__get_IsEmpty(xs_3):
        ...
        def _arrow75(__unit: None = None, folder: Any = folder, state: Any = state, xs: Any = xs) -> FSharpList[_STATE]:
...
def map_fold(
    ...
    def folder(
        ...
        def _arrow81(__unit: None = None, tupled_arg: Any = tupled_arg, x: Any = x) -> FSharpList[_RESULT]:
...
def try_find(f: Callable[[__A], bool], xs: FSharpList[__A]) -> __A | None:
    def _arrow83(x: __A | None = None, f: Any = f, xs: Any = xs) -> __A | None:
...
def partition(f: Callable[[_T], bool], xs: FSharpList[_T]) -> tuple[FSharpList[_T], FSharpList[_T]]:
    ...
    def folder(
        ...
        if f(x):
            ...
            def _arrow84(__unit: None = None, tupled_arg: Any = tupled_arg, x: Any = x) -> FSharpList[_T]:
                t: FSharpList[_T] = FSharpList(x, None)
                lacc.tail = t
                return t
...
def contains(value: _T, xs: FSharpList[_T], eq: IEqualityComparer_1[Any]) -> bool:
    def _arrow86(v: _T | None = None, value: Any = value, xs: Any = xs, eq: Any = eq) -> bool:
...
def initialize(n: int, f: Callable[[int], _T]) -> FSharpList[_T]:
    ...
    for i in range(0, (n - 1) + 1, 1):
        ...
        def _arrow87(__unit: None = None, n: Any = n, f: Any = f) -> FSharpList[_T]:
...
def replicate(n: int, x: __A) -> FSharpList[__A]:
    def _arrow88(_arg: int, n: Any = n, x: Any = x) -> __A:
        return x
...
def sort(xs: FSharpList[_T], comparer: IComparer_1[_T]) -> FSharpList[_T]:
    def _arrow95(x: _T, y: _T, xs: Any = xs, comparer: Any = comparer) -> int:
...
def sort_by(projection: Callable[[_T], _U], xs: FSharpList[_T], comparer: IComparer_1[_U]) -> FSharpList[_T]:
    def _arrow96(x: _T, y: _T, projection: Any = projection, xs: Any = xs, comparer: Any = comparer) -> int:
...
def sort_descending(xs: FSharpList[_T], comparer: IComparer_1[_T]) -> FSharpList[_T]:
    def _arrow97(x: _T, y: _T, xs: Any = xs, comparer: Any = comparer) -> int:
...
def sort_by_descending(projection: Callable[[_T], _U], xs: FSharpList[_T], comparer: IComparer_1[_U]) -> FSharpList[_T]:
    def _arrow98(x: _T, y: _T, projection: Any = projection, xs: Any = xs, comparer: Any = comparer) -> int:
...
def max_by(projection: Callable[[_T], _U], xs: FSharpList[_T], comparer: IComparer_1[_U]) -> _T:
    def _arrow101(x: _T, y: _T, projection: Any = projection, xs: Any = xs, comparer: Any = comparer) -> _T:
...
def max(xs: FSharpList[_T], comparer: IComparer_1[_T]) -> _T:
    def _arrow102(x: _T, y: _T, xs: Any = xs, comparer: Any = comparer) -> _T:
...
def min_by(projection: Callable[[_T], _U], xs: FSharpList[_T], comparer: IComparer_1[_U]) -> _T:
    def _arrow103(x: _T, y: _T, projection: Any = projection, xs: Any = xs, comparer: Any = comparer) -> _T:
...
def min(xs: FSharpList[_T], comparer: IComparer_1[_T]) -> _T:
    def _arrow104(x: _T, y: _T, xs: Any = xs, comparer: Any = comparer) -> _T:
...
def all_pairs(xs: FSharpList[_T1], ys: FSharpList[_T2]) -> FSharpList[tuple[_T1, _T2]]:
    ...
    def _arrow108(x: _T1 | None = None, xs: Any = xs, ys: Any = ys) -> None:
        def _arrow107(y: _T2 | None = None) -> None:
            nonlocal node
    ...
    def loop(
        ...
        while True:
            ...
            if i <= 0:
                ...
                def _arrow109(__unit: None = None, i: Any = i, acc: Any = acc, xs_1: Any = xs_1) -> FSharpList[_T]:
    ...
    def loop(
        ...
        while True:
            ...
            if i <= 0:
                ...
                def _arrow111(__unit: None = None, i: Any = i, acc: Any = acc, xs_1: Any = xs_1) -> FSharpList[_T]:
                    t: FSharpList[_T] = FSharpList(FSharpList__get_Head(xs_1), None)
                    acc.tail = t
                    return t
...
def insert_at(index: int, y: _T, xs: FSharpList[_T]) -> FSharpList[_T]:
    ...
    def _arrow112(__unit: None = None, index: Any = index, y: Any = y, xs: Any = xs) -> FSharpList[_T]:
        raise Exception((SR_indexOutOfBounds + "\\nParameter name: ") + "index")
...
def insert_many_at(index: int, ys: IEnumerable_1[_T], xs: FSharpList[_T]) -> FSharpList[_T]:
    ...
    def _arrow113(__unit: None = None, index: Any = index, ys: Any = ys, xs: Any = xs) -> FSharpList[_T]:
        raise Exception((SR_indexOutOfBounds + "\\nParameter name: ") + "index")
