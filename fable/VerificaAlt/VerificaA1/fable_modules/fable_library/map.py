...
MapTreeLeaf_2_reflection = _expr248
...
MapTreeNode_2_reflection = _expr249
...
def MapTreeModule_rebalance(
    ...
    if t2h > (t1h + 2):
        ...
        if isinstance(match_value, MapTreeNode_2):
            ...
            def _arrow250(__unit: None = None, t1: Any = t1, k: Any = k, v: Any = v, t2: Any = t2) -> int:
...
def MapTreeModule_copyToArray(m: MapTreeLeaf_2[__A, __B] | None, arr: Array[Any], i: int) -> None:
    ...
    def _arrow252(x: __A, y: __B, m: Any = m, arr: Any = arr, i: Any = i) -> None:
        nonlocal j
        arr[j] = (x, y)
        j = (j + 1) or 0

    MapTreeModule_iter(_arrow252, m)
...
def MapTreeModule_ofList(comparer: IComparer_1[__A], l: FSharpList[tuple[__A, __B]]) -> MapTreeLeaf_2[__A, __B] | None:
    ...
    return fold_1(_arrow253, MapTreeModule_empty(), l)
...
MapTreeModule_MapIterator_2_reflection = _expr254
...
def MapTreeModule_mkIEnumerator(m: MapTreeLeaf_2[_A, _B] | None = None) -> IEnumerator[Any]:
    ...
    class ObjectExpr255(IEnumerator[Any]):
...
def _expr258(gen0: TypeInfo, gen1: TypeInfo) -> TypeInfo:
...
class FSharpMap(Generic[_KEY, _VALUE]):
    ...
    def __str__(self, __unit: None = None) -> str:
        ...
        def _arrow256(kv: Any) -> str:
            return format("({0}, {1})", kv[0], kv[1])

        return ("map [" + join("; ", map_1(_arrow256, this))) + "]"
    ...
    def delete(self, _arg: _KEY | None = None) -> bool:
        raise Exception("Map cannot be mutated")
        return False
