...
SetTreeLeaf_1_reflection = _expr230
...
SetTreeNode_1_reflection = _expr231
...
def SetTreeModule_rebalance(
    ...
    if t2h > (t1h + 2):
        ...
        if isinstance(match_value, SetTreeNode_1):
            ...
            def _arrow232(__unit: None = None, t1: Any = t1, v: Any = v, t2: Any = t2) -> int:
...
def SetTreeModule_subset(
    ...
    def _arrow234(x: __A | None = None, comparer: Any = comparer, a: Any = a, b: Any = b) -> bool:
        return SetTreeModule_mem(comparer, x, b)

    return SetTreeModule_forall(_arrow234, a)
...
def SetTreeModule_properSubset(
    ...
    if SetTreeModule_forall(_arrow235, a):

        def _arrow236(x_1: __A | None = None, comparer: Any = comparer, a: Any = a, b: Any = b) -> bool:
            return not SetTreeModule_mem(comparer, x_1, a)

        return SetTreeModule_exists(_arrow236, b)
...
SetTreeModule_SetIterator_1_reflection = _expr237
...
def SetTreeModule_mkIEnumerator(s: SetTreeLeaf_1[_A] | None = None) -> IEnumerator[_A]:
    ...
    class ObjectExpr238(IEnumerator[_A_]):
...
def SetTreeModule_copyToArray(s: SetTreeLeaf_1[__A] | None, arr: Array[__A], i: int) -> None:
    ...
    def _arrow239(x: __A | None = None, s: Any = s, arr: Any = arr, i: Any = i) -> None:
        nonlocal j
        arr[j] = x
        j = (j + 1) or 0

    SetTreeModule_iter(_arrow239, s)
...
def SetTreeModule_ofArray(comparer: IComparer_1[__A], l: Array[__A]) -> SetTreeLeaf_1[__A] | None:
    ...
    return fold_1(_arrow240, SetTreeModule_empty(), l)
...
def SetTreeModule_ofList(comparer: IComparer_1[__A], l: FSharpList[__A]) -> SetTreeLeaf_1[__A] | None:
    ...
    return fold_2(_arrow241, SetTreeModule_empty(), l)
...
class FSharpSet(Generic[_T]):
    ...
    def __str__(self, __unit: None = None) -> str:
        ...
        def _arrow242(x: _T | None = None) -> str:
            copy_of_struct: _T = x
            return to_string(copy_of_struct)

        return ("set [" + join("; ", map_1(_arrow242, this))) + "]"
    ...
    def delete(self, k: _T | None = None) -> bool:
        raise Exception("Set cannot be mutated")
        return False
...
def FSharpSet__Fold(s: FSharpSet[_T], f: Callable[[_T, __A], __A], z: __A) -> __A:
    ...
    def _arrow244(x: __A, z_1: _T, s: Any = s, f: Any = f, z: Any = z) -> __A:
        return f_1(z_1, x)

    return SetTreeModule_fold(_arrow244, z, FSharpSet__get_Tree(s))
...
def FSharpSet__Map(s: FSharpSet[_T], f: Callable[[_T], _U], comparer: IComparer_1[_U]) -> FSharpSet[_U]:
    ...
    return FSharpSet__ctor(comparer, SetTreeModule_fold(_arrow245, SetTreeModule_empty(), FSharpSet__get_Tree(s)))
...
def FSharpSet_IntersectionMany(sets: IEnumerable_1[FSharpSet[_T]]) -> FSharpSet[_T]:
    def _arrow246(s1: FSharpSet[_T], s2: FSharpSet[_T], sets: Any = sets) -> FSharpSet[_T]:
        return FSharpSet_Intersection(s1, s2)

    return reduce(_arrow246, sets)
...
def union_many(sets: IEnumerable_1[FSharpSet[_T]], comparer: IComparer_1[_T]) -> FSharpSet[_T]:
    def _arrow247(s1: FSharpSet[_T], s2: FSharpSet[_T], sets: Any = sets, comparer: Any = comparer) -> FSharpSet[_T]:
        return FSharpSet_op_Addition(s1, s2)

    return fold_3(_arrow247, FSharpSet_Empty(comparer), sets)
