...
def distinct(xs: IEnumerable_1[_T], comparer: IEqualityComparer_1[Any]) -> IEnumerable_1[_T]:
    def _arrow114(__unit: None = None, xs: Any = xs, comparer: Any = comparer) -> IEnumerable_1[_T]:
...
def count_by(
    ...
    def _arrow120(
        ...
        def _arrow119(key_1: _KEY | None = None) -> tuple[_KEY, int]:
...
def group_by(
    ...
    def _arrow124(
        ...
        def _arrow123(key_1: _KEY | None = None) -> tuple[_KEY, IEnumerable_1[_T]]:
            return (key_1, get_item_from_dict(dict_1, key_1))
