                ...
                if outer_opt_1 is not None:
                    if inner_opt_1 is not None:
                        ...
                        if outer_1.System_Collections_IEnumerator_MoveNext():
                            ...
                            def _arrow135(__unit: None = None) -> IEnumerator[_T]:
...
def delay(generator: Callable[[], IEnumerable_1[_T]]) -> IEnumerable_1[_T]:
    def _arrow136(__unit: None = None, generator: Any = generator) -> IEnumerator[_T]:
...
def concat(sources: IEnumerable_1[Any]) -> IEnumerable_1[Any]:
    def _arrow137(__unit: None = None, sources: Any = sources) -> IEnumerator[_T]:
...
def unfold(generator: Callable[[_STATE], tuple[_T, _STATE] | None], state: _STATE) -> IEnumerable_1[_T]:
    def _arrow138(__unit: None = None, generator: Any = generator, state: Any = state) -> IEnumerator[_T]:
        return Enumerator_unfold(generator, state)

    return mk_seq(_arrow138)


def empty(__unit: None = None) -> IEnumerable_1[Any]:
    def _arrow139(__unit: None = None) -> IEnumerable_1[_T]:
        return [0] * 0
...
def singleton(x: _T | None = None) -> IEnumerable_1[_T]:
    def _arrow140(__unit: None = None, x: Any = x) -> IEnumerable_1[_T]:
...
def generate_indexed(
    ...
    def _arrow143(
        ...
        def _arrow142(x: __A | None = None) -> __B | None:
            nonlocal i
            i = (i + 1) or 0
            return compute(i, x)

        return Enumerator_generateWhileSome(create, _arrow142, dispose)
...
def cast(xs: IEnumerable_1[_T]) -> IEnumerable_1[_T]:
    def _arrow144(__unit: None = None, xs: Any = xs) -> IEnumerator[_T]:
        check_non_null("source", xs)
...
def choose(chooser: Callable[[_T], _U | None], xs: IEnumerable_1[_T]) -> IEnumerable_1[_U]:
    def _arrow145(__unit: None = None, chooser: Any = chooser, xs: Any = xs) -> IEnumerator[_T]:
        return of_seq(xs)

    def _arrow146(e: IEnumerator[_T], chooser: Any = chooser, xs: Any = xs) -> _U | None:
        curr: _U | None = None
    ...
    def _arrow147(e_1: IEnumerator[_T], chooser: Any = chooser, xs: Any = xs) -> None:
        dispose_2(e_1)

    return generate(_arrow145, _arrow146, _arrow147)
...
def enumerate_from_functions(
    ...
    return generate(create, _arrow148, _arrow149)
...
def enumerate_then_finally(source: IEnumerable_1[_T], compensation: Callable[[], None]) -> IEnumerable_1[_T]:
    ...
    def _arrow150(__unit: None = None, source: Any = source, compensation: Any = compensation) -> IEnumerator[_T]:
        try:
...
def enumerate_using(resource: _T, source: Callable[[_T], __A]) -> IEnumerable_1[Any]:
    ...
    def _arrow151(__unit: None = None, resource: Any = resource, source: Any = source) -> IEnumerator[_U]:
        try:
    ...
    return mk_seq(_arrow151)


def enumerate_while(guard: Callable[[], bool], xs: IEnumerable_1[_T]) -> IEnumerable_1[_T]:
    def _arrow152(i: int, guard: Any = guard, xs: Any = xs) -> tuple[IEnumerable_1[_T], int] | None:
        return ((xs, i + 1)) if guard() else None

    return concat(unfold(_arrow152, 0))
...
def for_all(predicate: Callable[[__A], bool], xs: IEnumerable_1[__A]) -> bool:
    def _arrow153(x: __A | None = None, predicate: Any = predicate, xs: Any = xs) -> bool:
        return not predicate(x)

    return not exists(_arrow153, xs)


def for_all2(predicate: Callable[[__A, __B], bool], xs: IEnumerable_1[__A], ys: IEnumerable_1[__B]) -> bool:
    def _arrow154(x: __A, y: __B, predicate: Any = predicate, xs: Any = xs, ys: Any = ys) -> bool:
        return not predicate(x, y)

    return not exists2(_arrow154, xs, ys)
...
def initialize(count: int, f: Callable[[int], __A]) -> IEnumerable_1[__A]:
    def _arrow155(i: int, count: Any = count, f: Any = f) -> tuple[__A, int] | None:
        return ((f(i), i + 1)) if (i < count) else None

    return unfold(_arrow155, 0)
...
def iterate(action: Callable[[__A], None], xs: IEnumerable_1[__A]) -> None:
    def _arrow156(unit_var: None, x: __A, action: Any = action, xs: Any = xs) -> None:
        action(x)

    fold(_arrow156, None, xs)


def iterate2(action: Callable[[__A, __B], None], xs: IEnumerable_1[__A], ys: IEnumerable_1[__B]) -> None:
    def _arrow157(unit_var: None, x: __A, y: __B, action: Any = action, xs: Any = xs, ys: Any = ys) -> None:
        action(x, y)

    fold2(_arrow157, None, xs, ys)


def iterate_indexed(action: Callable[[int, __A], None], xs: IEnumerable_1[__A]) -> None:
    def _arrow158(i: int, x: __A, action: Any = action, xs: Any = xs) -> int:
        action(i, x)
        return i + 1

    ignore(fold(_arrow158, 0, xs))


def iterate_indexed2(action: Callable[[int, __A, __B], None], xs: IEnumerable_1[__A], ys: IEnumerable_1[__B]) -> None:
    def _arrow159(i: int, x: __A, y: __B, action: Any = action, xs: Any = xs, ys: Any = ys) -> int:
        action(i, x, y)
        return i + 1

    ignore(fold2(_arrow159, 0, xs, ys))
...
def map(mapping: Callable[[_T], _U], xs: IEnumerable_1[_T]) -> IEnumerable_1[_U]:
    def _arrow160(__unit: None = None, mapping: Any = mapping, xs: Any = xs) -> IEnumerator[_T]:
        return of_seq(xs)

    def _arrow161(e: IEnumerator[_T], mapping: Any = mapping, xs: Any = xs) -> _U | None:
        return (
    ...
    def _arrow162(e_1: IEnumerator[_T], mapping: Any = mapping, xs: Any = xs) -> None:
        dispose_2(e_1)

    return generate(_arrow160, _arrow161, _arrow162)
...
def map_indexed(mapping: Callable[[int, _T], _U], xs: IEnumerable_1[_T]) -> IEnumerable_1[_U]:
    ...
    def _arrow164(i: int, e: IEnumerator[_T], mapping: Any = mapping, xs: Any = xs) -> _U | None:
        return (
...
def map2(mapping: Callable[[_T1, _T2], _U], xs: IEnumerable_1[_T1], ys: IEnumerable_1[_T2]) -> IEnumerable_1[_U]:
    ...
    return generate(_arrow166, _arrow167, _arrow168)
...
def map3(
    ...
    return generate(_arrow172, _arrow173, _arrow174)


def read_only(xs: IEnumerable_1[_T]) -> IEnumerable_1[_T]:
    check_non_null("source", xs)

    def _arrow175(x: _T | None = None, xs: Any = xs) -> _T | None:
        return x

    return map(_arrow175, xs)
...
CachedSeq_1_reflection = _expr176
...
def cache(source: IEnumerable_1[_T]) -> IEnumerable_1[_T]:
    ...
    def _arrow177(i_1: int, source: Any = source) -> tuple[_T, int] | None:
    ...
    return CachedSeq_1__ctor_Z7A8347D4(cleanup, unfold(_arrow177, 0))


def all_pairs(xs: IEnumerable_1[_T1], ys: IEnumerable_1[_T2]) -> IEnumerable_1[tuple[_T1, _T2]]:
    ys_cache: IEnumerable_1[_T2] = cache(ys)

    def _arrow178(__unit: None = None, xs: Any = xs, ys: Any = ys) -> IEnumerable_1[tuple[_T1, _T2]]:
...
def replicate(n: int, x: __A) -> IEnumerable_1[__A]:
    def _arrow179(_arg: int, n: Any = n, x: Any = x) -> __A:
        return x

    return initialize(n, _arrow179)


def reverse(xs: IEnumerable_1[_T]) -> IEnumerable_1[_T]:
    def _arrow180(__unit: None = None, xs: Any = xs) -> IEnumerable_1[_T]:
        return of_array(reverse_1(to_array(xs)))

    return delay(_arrow180)


def scan(folder: Callable[[_STATE, _T], _STATE], state: _STATE, xs: IEnumerable_1[_T]) -> IEnumerable_1[_STATE]:
    def _arrow181(__unit: None = None, folder: Any = folder, state: Any = state, xs: Any = xs) -> IEnumerable_1[_STATE]:
        acc: _STATE = state
...
def scan_back(folder: Callable[[_T, _STATE], _STATE], xs: IEnumerable_1[_T], state: _STATE) -> IEnumerable_1[_STATE]:
    def _arrow182(__unit: None = None, folder: Any = folder, xs: Any = xs, state: Any = state) -> IEnumerable_1[_STATE]:
...
def skip(count: int, source: IEnumerable_1[_T]) -> IEnumerable_1[_T]:
    def _arrow183(__unit: None = None, count: Any = count, source: Any = source) -> IEnumerator[_T]:
    ...
    return mk_seq(_arrow183)


def skip_while(predicate: Callable[[_T], bool], xs: IEnumerable_1[_T]) -> IEnumerable_1[_T]:
    def _arrow184(__unit: None = None, predicate: Any = predicate, xs: Any = xs) -> IEnumerable_1[_T]:
        skipped: bool = True
...
def take(count: int, xs: IEnumerable_1[_T]) -> IEnumerable_1[_T]:
    def _arrow185(__unit: None = None, count: Any = count, xs: Any = xs) -> IEnumerator[_T]:
        return of_seq(xs)

    def _arrow186(i: int, e: IEnumerator[_T], count: Any = count, xs: Any = xs) -> _T | None:
        if i < count:
            if e.System_Collections_IEnumerator_MoveNext():
                return some(e.System_Collections_Generic_IEnumerator_1_get_Current())
    ...
    def _arrow187(e_1: IEnumerator[_T], count: Any = count, xs: Any = xs) -> None:
        dispose_2(e_1)
...
def take_while(predicate: Callable[[_T], bool], xs: IEnumerable_1[_T]) -> IEnumerable_1[_T]:
    def _arrow188(__unit: None = None, predicate: Any = predicate, xs: Any = xs) -> IEnumerator[_T]:
        return of_seq(xs)

    def _arrow189(e: IEnumerator[_T], predicate: Any = predicate, xs: Any = xs) -> _T | None:
        return (
    ...
    def _arrow190(e_1: IEnumerator[_T], predicate: Any = predicate, xs: Any = xs) -> None:
        dispose_2(e_1)

    return generate(_arrow188, _arrow189, _arrow190)


def truncate(count: int, xs: IEnumerable_1[_T]) -> IEnumerable_1[_T]:
    def _arrow191(__unit: None = None, count: Any = count, xs: Any = xs) -> IEnumerator[_T]:
        return of_seq(xs)

    def _arrow192(i: int, e: IEnumerator[_T], count: Any = count, xs: Any = xs) -> _T | None:
        return (
            some(e.System_Collections_Generic_IEnumerator_1_get_Current())
    ...
    def _arrow193(e_1: IEnumerator[_T], count: Any = count, xs: Any = xs) -> None:
        dispose_2(e_1)
...
def zip(xs: IEnumerable_1[_T1], ys: IEnumerable_1[_T2]) -> IEnumerable_1[tuple[_T1, _T2]]:
    def _arrow194(x: _T1, y: _T2, xs: Any = xs, ys: Any = ys) -> tuple[_T1, _T2]:
        return (x, y)

    return map2(_arrow194, xs, ys)


def zip3(xs: IEnumerable_1[_T1], ys: IEnumerable_1[_T2], zs: IEnumerable_1[_T3]) -> IEnumerable_1[tuple[_T1, _T2, _T3]]:
    def _arrow195(x: _T1, y: _T2, z: _T3, xs: Any = xs, ys: Any = ys, zs: Any = zs) -> tuple[_T1, _T2, _T3]:
        return (x, y, z)

    return map3(_arrow195, xs, ys, zs)


def collect(mapping: Callable[[_T], _COLLECTION], xs: IEnumerable_1[_T]) -> IEnumerable_1[Any]:
    def _arrow196(__unit: None = None, mapping: Any = mapping, xs: Any = xs) -> IEnumerable_1[_U]:
...
def pairwise(xs: IEnumerable_1[_T]) -> IEnumerable_1[tuple[_T, _T]]:
    def _arrow197(__unit: None = None, xs: Any = xs) -> IEnumerable_1[tuple[_T, _T]]:
...
def split_into(chunks: int, xs: IEnumerable_1[_T]) -> IEnumerable_1[Array[_T]]:
    def _arrow198(__unit: None = None, chunks: Any = chunks, xs: Any = xs) -> IEnumerable_1[Array[_T]]:
...
def windowed(window_size: int, xs: IEnumerable_1[_T]) -> IEnumerable_1[Array[_T]]:
    def _arrow199(__unit: None = None, window_size: Any = window_size, xs: Any = xs) -> IEnumerable_1[Array[_T]]:
...
def transpose(xss: IEnumerable_1[Any]) -> IEnumerable_1[IEnumerable_1[Any]]:
    def _arrow200(__unit: None = None, xss: Any = xss) -> IEnumerable_1[IEnumerable_1[_T]]:
...
def sort_with(comparer: Callable[[_T, _T], int], xs: IEnumerable_1[_T]) -> IEnumerable_1[_T]:
    def _arrow201(__unit: None = None, comparer: Any = comparer, xs: Any = xs) -> IEnumerable_1[_T]:
        arr: Array[_T] = to_array(xs)
        arr.sort()
        return of_array(arr)
...
def sort(xs: IEnumerable_1[_T], comparer: IComparer_1[_T]) -> IEnumerable_1[_T]:
    def _arrow202(x: _T, y: _T, xs: Any = xs, comparer: Any = comparer) -> int:
        return comparer.Compare(x, y)

    return sort_with(_arrow202, xs)


def sort_by(projection: Callable[[_T], _U], xs: IEnumerable_1[_T], comparer: IComparer_1[_U]) -> IEnumerable_1[_T]:
    def _arrow203(x: _T, y: _T, projection: Any = projection, xs: Any = xs, comparer: Any = comparer) -> int:
...
def sort_descending(xs: IEnumerable_1[_T], comparer: IComparer_1[_T]) -> IEnumerable_1[_T]:
    def _arrow204(x: _T, y: _T, xs: Any = xs, comparer: Any = comparer) -> int:
...
def sort_by_descending(
    ...
    def _arrow205(x: _T, y: _T, projection: Any = projection, xs: Any = xs, comparer: Any = comparer) -> int:
...
def sum(xs: IEnumerable_1[_T], adder: IGenericAdder_1[_T]) -> _T:
    def _arrow206(acc: _T, x: _T, xs: Any = xs, adder: Any = adder) -> _T:
        return adder.Add(acc, x)

    return fold(_arrow206, adder.GetZero(), xs)


def sum_by(f: Callable[[_T], _U], xs: IEnumerable_1[_T], adder: IGenericAdder_1[_U]) -> _U:
    def _arrow207(acc: _U, x: _T, f: Any = f, xs: Any = xs, adder: Any = adder) -> _U:
...
def max_by(projection: Callable[[_T], _U], xs: IEnumerable_1[_T], comparer: IComparer_1[_U]) -> _T:
    def _arrow208(x: _T, y: _T, projection: Any = projection, xs: Any = xs, comparer: Any = comparer) -> _T:
        return y if (comparer.Compare(projection(y), projection(x)) > 0) else x

    return reduce(_arrow208, xs)


def max(xs: IEnumerable_1[_T], comparer: IComparer_1[_T]) -> _T:
    def _arrow209(x: _T, y: _T, xs: Any = xs, comparer: Any = comparer) -> _T:
...
def min_by(projection: Callable[[_T], _U], xs: IEnumerable_1[_T], comparer: IComparer_1[_U]) -> _T:
    def _arrow210(x: _T, y: _T, projection: Any = projection, xs: Any = xs, comparer: Any = comparer) -> _T:
...
def min(xs: IEnumerable_1[_T], comparer: IComparer_1[_T]) -> _T:
    def _arrow211(x: _T, y: _T, xs: Any = xs, comparer: Any = comparer) -> _T:
...
def average_by(f: Callable[[_T], _U], xs: IEnumerable_1[_T], averager: IGenericAverager_1[_U]) -> _U:
    ...
    def _arrow212(acc: _U, x: _T, f: Any = f, xs: Any = xs, averager: Any = averager) -> _U:
        nonlocal count
        count = (count + 1) or 0
        return averager.Add(acc, f(x))

    total: _U = fold(_arrow212, averager.GetZero(), xs)
    if count == 0:
        raise Exception((SR_inputSequenceEmpty + "\\nParameter name: ") + "source")
...
def permute(f: Callable[[int], int], xs: IEnumerable_1[_T]) -> IEnumerable_1[_T]:
    def _arrow213(__unit: None = None, f: Any = f, xs: Any = xs) -> IEnumerable_1[_T]:
        return of_array(permute_1(f, to_array(xs)))

    return delay(_arrow213)


def chunk_by_size(chunk_size: int, xs: IEnumerable_1[_T]) -> IEnumerable_1[Array[_T]]:
    def _arrow214(__unit: None = None, chunk_size: Any = chunk_size, xs: Any = xs) -> IEnumerable_1[Array[_T]]:
...
def insert_at(index: int, y: _T, xs: IEnumerable_1[_T]) -> IEnumerable_1[_T]:
    ...
    def _arrow215(__unit: None = None, index: Any = index, y: Any = y, xs: Any = xs) -> IEnumerator[_T]:
        return of_seq(xs)

    def _arrow216(i: int, e: IEnumerator[_T], index: Any = index, y: Any = y, xs: Any = xs) -> _T | None:
        nonlocal is_done
    ...
    def _arrow217(e_1: IEnumerator[_T], index: Any = index, y: Any = y, xs: Any = xs) -> None:
        dispose_2(e_1)

    return generate_indexed(_arrow215, _arrow216, _arrow217)
...
def remove_at(index: int, xs: IEnumerable_1[_T]) -> IEnumerable_1[_T]:
    ...
    def _arrow221(__unit: None = None, index: Any = index, xs: Any = xs) -> IEnumerator[_T]:
        return of_seq(xs)

    def _arrow222(i: int, e: IEnumerator[_T], index: Any = index, xs: Any = xs) -> _T | None:
        nonlocal is_done
        if e.System_Collections_IEnumerator_MoveNext() if (True if is_done else (i < index)) else False:
            return some(e.System_Collections_Generic_IEnumerator_1_get_Current())
    ...
    def _arrow223(e_1: IEnumerator[_T], index: Any = index, xs: Any = xs) -> None:
        dispose_2(e_1)
...
def remove_many_at(index: int, count: int, xs: IEnumerable_1[_T]) -> IEnumerable_1[_T]:
    ...
    def _arrow224(__unit: None = None, index: Any = index, count: Any = count, xs: Any = xs) -> IEnumerator[_T]:
        return of_seq(xs)

    def _arrow225(i: int, e: IEnumerator[_T], index: Any = index, count: Any = count, xs: Any = xs) -> _T | None:
        if i < index:
            if e.System_Collections_IEnumerator_MoveNext():
                return some(e.System_Collections_Generic_IEnumerator_1_get_Current())
    ...
    def _arrow226(e_1: IEnumerator[_T], index: Any = index, count: Any = count, xs: Any = xs) -> None:
        dispose_2(e_1)
...
def update_at(index: int, y: _T, xs: IEnumerable_1[_T]) -> IEnumerable_1[_T]:
    ...
    def _arrow227(__unit: None = None, index: Any = index, y: Any = y, xs: Any = xs) -> IEnumerator[_T]:
        return of_seq(xs)

    def _arrow228(i: int, e: IEnumerator[_T], index: Any = index, y: Any = y, xs: Any = xs) -> _T | None:
        nonlocal is_done
        if e.System_Collections_IEnumerator_MoveNext() if (True if is_done else (i < index)) else False:
            return some(e.System_Collections_Generic_IEnumerator_1_get_Current())
    ...
    def _arrow229(e_1: IEnumerator[_T], index: Any = index, y: Any = y, xs: Any = xs) -> None:
        dispose_2(e_1)
